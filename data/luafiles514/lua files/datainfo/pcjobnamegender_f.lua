...
function ReqPCJobNameMan(jobID)
  if PCJobNameTableMan[jobID] ~= nil then
    return PCJobNameTableMan[jobID]
  end
  return ""
end
function ReqPCJobNameWoman(jobID)
  if PCJobNameTableWoman[jobID] ~= nil then
    return PCJobNameTableWoman[jobID]
  end
  return ""
end
