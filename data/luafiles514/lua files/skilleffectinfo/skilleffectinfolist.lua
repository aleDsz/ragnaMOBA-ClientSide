SKILL_EFFECT_INFO_LIST = {
  [SKID.NJ_KUNAI] = {
    waveFileName = "effect\\\180\209\192\218_\180\248\193\246\177\226.wav",
    effectNum = 1,
    effectIDs = {
      EFID.EF_THROWITEM8
    },
  ...
  [SKID.KO_SETSUDAN] = {
    ...
    targetWaveFileName = "effect\\T_\192\252\177\226.wav",
    targetEffectNum = 1,
    targetEffectID = {
      EFID.EF_KO_SETSUDAN
    },
  ...
  [SKID.KO_BAKURETSU] = {
    ...
    targetWaveFileName = "effect\\\198\248\191\176\183\230.wav",
    targetEffectNum = 1,
    targetEffectID = {
  ...
  [SKID.KO_HAPPOKUNAI] = {
    beginMotionType = ACTOR_STATE.ST_NINJASKILL2,
    waveFileName = "effect\\T_\200\184\191\192\184\174\194\247\177\226.wav",
    effectNum = 2,
    effectID = {
  ...
  [SKID.KG_KYOMU] = {
    targetWaveFileName = "effect\\t_\191\161\179\202\193\246\185\230\195\226.wav",
    targetEffectNum = 1,
    targetEffectID = {
      EFID.EF_KG_KYOMU
    },
  ...
  [SKID.KG_KAGEMUSYA] = {
    targetWaveFileName = "effect\\mon_\177\221\176\173\186\210\177\171.wav",
    targetEffectNum = 1,
    targetEffectID = {
      EFID.EF_ENERGYCOAT
    },
  ...
  [SKID.OB_ZANGETSU] = {
    beginMotionType = ACTOR_STATE.ST_NINJAREADY,
    beginEffectID = EFID.EF_BEGINSPELL,
    targetWaveFileName = "effect\\t_\181\251\181\237\199\209\184\182\185\253.wav",
    targetEffectNum = 1,
    targetEffectID = {
      EFID.EF_ZANGETSU
    },
