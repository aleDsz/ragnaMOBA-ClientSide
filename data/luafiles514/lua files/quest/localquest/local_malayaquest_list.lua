LOCAL_MalayaQuest_List = {
  {
    ...
    list = {
      ...
      {
        name = "Traditional Spiritual Protection and Impudent Girl",
        list = {
          {
          ...
          {
            name = "Deliver Spiritual Protection-Pedro\206",
            scrfilename = "malayaQuest",
            questID = 7368
          },
          {
